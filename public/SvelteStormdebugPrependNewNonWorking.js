...
function checkIfChanged(componentState, i) {
  ...
  console.log(`\n🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵`);
  console.log(
    '🔴🟠🟡🟢🔵🟣 | file: SvelteStormdebugPrepend.js | line 39 | checkIfChanged | i',
    i
  );
  console.log(
    '🔴🟠🟡🟢🔵🟣 | file: SvelteStormdebugPrepend.js | line 40 | checkIfChanged | componentState',
    componentState
  );
  console.log(
    '🔴🟠🟡🟢🔵🟣 | file: SvelteStormdebugPrepend.js | line 41 | checkIfChanged | cacheState.length',
    cacheState.length
  );
  console.log(
    '🔴🟠🟡🟢🔵🟣 | file: SvelteStormdebugPrepend.js | line 42 | checkIfChanged | cacheState',
    cacheState
  );
  console.log(`\n🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵`);
  console.log(`\n🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵🔵`);
...
function saveAndDispatchState(event) {
  console.log(
    `\n🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴`,
    'hello'
  );
  console.log(
    '🔴🟠🟡🟢🔵🟣 | file: SvelteStormdebugPrepend.js | line 87 | saveAndDispatchState | event',
    event
  );
  console.log(`\n🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴🔴`);
  const curState = [];
  ...
  if (
    JSON.stringify(curState) != compCacheState &&
    lastCacheStateLength != curState.length
  ) {
...
function setupListeners(root) {
  root.addEventListener('SvelteRegisterBlock', (e) => saveAndDispatchState(e));
