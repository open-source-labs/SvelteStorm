...
var app = (function () {
    ...
    let monaco_promise;
    let _monaco;
    monaco_promise = Promise.resolve().then(function () { return monaco$1; });
    ...
    function create_b_slot(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div1, "class", "svelte-1vf0yfa");
    			attr(section, "slot", "b");
    ...
    var monaco$1 = /*#__PURE__*/Object.freeze({
        __proto__: null,
        'default': monaco
    });
