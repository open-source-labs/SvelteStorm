/*
* =========================================================
*   The following is SvelteStorm 5.0 Performance Monitoring Code.
* =========================================================
*/
...
ipcRenderer.on('PERFORMANCE', (event, data) => {
    if (data.message === 'PERFORMANCE') {
  ...
  /*
  * =========================================================
  *   The Above is SvelteStorm 5.0 Performance Monitoring Code.
  * =========================================================
  */