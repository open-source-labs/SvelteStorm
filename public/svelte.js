...
let monaco_promise;
let _monaco;
monaco_promise = import('./monaco-e4ad9810.js').then(function (n) { return n.m; });
...
function get_each_context(ctx, list, i) {
	...
	child_ctx[8] = list[i].items;
	return child_ctx;
}

// (37:0) {#if fileTreeTest}
function create_if_block$1(ctx) {
	let each_1_anchor;
	let current;
	let each_value = /*fileTreeTest*/ ctx[0];
	let each_blocks = [];
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*fileTreeTest, fileState, toggleVisibility*/ 7) {
				each_value = /*fileTreeTest*/ ctx[0];
				let i;
...
function create_else_block$1(ctx) {
	...
	return {
		c() {
			li = element("li");
			t = text(t_value);
			attr(li, "class", "liFiles svelte-oin3bz");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*fileTreeTest*/ 1 && t_value !== (t_value = /*name*/ ctx[7] + "")) set_data(t, t_value);
		},
		d(detaching) {
...
function create_if_block_2(ctx) {
	...
	return {
		c() {
			...
			attr(li, "class", li_class_value = "" + (null_to_empty(!/*fileState*/ ctx[1][/*path*/ ctx[6]]
			? "liFolderClosed"
			: "liFolderOpen") + " svelte-oin3bz"));
		},
		m(target, anchor) {
			insert(target, li, anchor);
			append(li, t);
			...
			if (!mounted) {
				dispose = listen(li, "click", function () {
					if (is_function(/*toggleVisibility*/ ctx[2](/*path*/ ctx[6]))) /*toggleVisibility*/ ctx[2](/*path*/ ctx[6]).apply(this, arguments);
				});
		...
		p(new_ctx, dirty) {
			...
			if (dirty & /*fileState, fileTreeTest*/ 3 && li_class_value !== (li_class_value = "" + (null_to_empty(!/*fileState*/ ctx[1][/*path*/ ctx[6]]
			? "liFolderClosed"
			: "liFolderOpen") + " svelte-oin3bz"))) {
...
// (45:4) {#if fileState[path] && items.length > 0}
function create_if_block_1(ctx) {
	...
	filetest = new FileTest({
			props: {
				fileTreeTest: /*items*/ ctx[8].sort(func)
			}
		});
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*fileTreeTest*/ 1) filetest_changes.fileTreeTest = /*items*/ ctx[8].sort(func);
...
// (38:0) {#each fileTreeTest as {path,name, items}}
function create_each_block(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*items*/ ctx[8].length > 0) return create_if_block_2;
		return create_else_block$1;
	}

	let current_block_type = select_block_type(ctx);
	let if_block0 = current_block_type(ctx);
	let if_block1 = /*fileState*/ ctx[1][/*path*/ ctx[6]] && /*items*/ ctx[8].length > 0 && create_if_block_1(ctx);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (/*fileState*/ ctx[1][/*path*/ ctx[6]] && /*items*/ ctx[8].length > 0) {
				if (if_block1) {
					if_block1.p(ctx, dirty);

					if (dirty & /*fileState, fileTreeTest*/ 3) {
...
function create_fragment$2(ctx) {
	let div;
	let current;
	let if_block = /*fileTreeTest*/ ctx[0] && create_if_block$1(ctx);

	return {
		c() {
			div = element("div");
			if (if_block) if_block.c();
			attr(div, "class", "directory svelte-oin3bz");
		},
		m(target, anchor) {
			insert(target, div, anchor);
		...
		p(ctx, [dirty]) {
			if (/*fileTreeTest*/ ctx[0]) {
				if (if_block) {
					if_block.p(ctx, dirty);

					if (dirty & /*fileTreeTest*/ 1) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		if ("fileTreeTest" in $$props) $$invalidate(0, fileTreeTest = $$props.fileTreeTest);
	};

	return [fileTreeTest, fileState, toggleVisibility];
}

class FileTest extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$2, create_fragment$2, safe_not_equal, { fileTreeTest: 0 });
	}
}
...
function create_fragment$1(ctx) {
	...
	filetest = new FileTest({
			props: { fileTreeTest: /*savedTree*/ ctx[0] }
		});
	...
	return {
		...
		p(ctx, [dirty]) {
			const filetest_changes = {};
			if (dirty & /*savedTree*/ 1) filetest_changes.fileTreeTest = /*savedTree*/ ctx[0];
			filetest.$set(filetest_changes);
		},
		i(local) {
			if (current) return;
