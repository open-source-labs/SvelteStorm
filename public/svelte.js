...
let monaco_promise;
let _monaco;
monaco_promise = import('./monaco-faeb0510.js').then(function (n) { return n.m; });
...
class Monaco_editor extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$2, create_fragment$2, safe_not_equal, { value: 1, language: 2 });
	}
}
...
function create_a_slot(ctx) {
	...
	return {
		c() {
			...
			if_block.c();
			attr(section, "slot", "a");
			attr(section, "class", "svelte-8zujcv");
		},
		m(target, anchor) {
...
function create_b_slot(ctx) {
	...
	return {
		c() {
			...
			t1 = text(/*name*/ ctx[0]);
			t2 = text("!");
			attr(h1, "class", "svelte-8zujcv");
			attr(div1, "class", "svelte-8zujcv");
			attr(section, "slot", "b");
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(main, "class", "svelte-8zujcv");
			attr(body, "class", "container svelte-8zujcv");
