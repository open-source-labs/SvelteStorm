...
let monaco_promise;
let _monaco;
monaco_promise = import('./monaco-d79398eb.js').then(function (n) { return n.m; });
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			t3 = space();
			div3 = element("div");
			div3.innerHTML = `<webview src="http://localhost:3000/" nodeintegration=""></webview>`;
			t4 = space();
			div5 = element("div");
			div5.innerHTML = `<div id="xterm"></div>`;
			attr(div0, "class", "box a svelte-khjrvb");
			attr(div1, "class", "box b svelte-khjrvb");
			attr(div2, "class", "box c svelte-khjrvb");
			attr(div3, "class", "box d svelte-khjrvb");
			attr(div5, "class", "box e svelte-khjrvb");
...
//# sourceMappingURL=svelte-2b0de40a.js.map
