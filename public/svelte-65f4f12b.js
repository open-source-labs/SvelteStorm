...
let monaco_promise;
let _monaco;
monaco_promise = import('./monaco-d2c639cf.js').then(function (n) { return n.m; });
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			t3 = space();
			div3 = element("div");
			div3.innerHTML = `<webview src="http://localhost:3000/"></webview>`;
			t4 = space();
			div5 = element("div");
...
//# sourceMappingURL=svelte-65f4f12b.js.map
